...
const PoliciesSearchRequestSchema = z.object({
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const validation = PoliciesSearchRequestSchema.safeParse(body);
    ...
    console.error('Policies search API error:', error);
    return createCorsResponse({
      success: false,
      error: {
        code: 'INTERNAL_ERROR',
